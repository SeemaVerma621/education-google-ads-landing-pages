...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {	
	...
	// ---------------------------------------------------------
	$url = 'https://script.google.com/macros/s/AKfycbx_tn_wsnhJOfQOkFWQ2xt_Gu2d-8i4y12dimtHKmK3DrORphWKTa33cTgo6cxodLLg/exec';
	$data = array(
		'full_name' => $full_name,
		'email' => $email,
		'phone' => $phone,
		...
		'utm_term' => $utm_term,
		'page_url' => $page_url,
		'website' => 'Jamia' // Identifier to differentiate sources
	);
