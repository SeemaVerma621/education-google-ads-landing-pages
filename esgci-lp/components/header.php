...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/ESGCI_Favicon.png"/>
    <title>Online DBA Course at ESGCI Doctorate in Business Administration  </title>
...
<!-- Google tag (gtag.js) -->
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9QWEXLBEHZ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9QWEXLBEHZ');
</script>
...
})(window,document,'script','dataLayer','GTM-KT6QSKK2');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KT6QSKK2"
    ...
    <div class="container">
        <nav class="nav">
            ...
            <div class="nav-header">
                    ...
                    <a href="https://esgci.distanceeducationschool.in/">  
            ...
            <li><a href="#certification">Approvals</a></li>
