...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/des-favicon.png"/>
    <title>Online DBA Programs: Fees, Eligibility & Admission 2025</title>
    ...
    <div class="container">
        <nav class="nav">
            ...
            <div class="nav-header">
                <div class="nav-title">
                    <a href="#" id="logo-link">  
                        <img src="assets/img/SODE-LOGO.png" class="logo" alt="IIM-Logo">
                    </a>
                </div>
            </div>
            <div class="nav-btn">
