...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {	
	...
	// ---------------------------------------------------------
	$url = 'https://script.google.com/macros/s/AKfycbzwGniicezrtBobRKX7QTTR1Q_qiz-JHxVisM53DQ_0dx_687n4VVfhTYfDluOKf3AE4w/exec';
	$data = array(
		'full_name' => $full_name,
		'email' => $email,
		'phone' => $phone,
		...
		'utm_term' => $utm_term,
		'page_url' => $page_url,
		'website' => '#' // Identifier to differentiate sources
	);
