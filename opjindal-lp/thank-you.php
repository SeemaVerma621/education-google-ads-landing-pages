...
<script>
  ...
  gtag('config', 'AW-10925120712');
	...
	<body>
		<!-- Event snippet for Opjindal DES IN conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-10925120712/Rb2ICNH_xscaEMi5wNko'});
</script>
		...
		<div class="thanku">
			...
			<div class="container">
				<div class="header">
					...
					<br>
					<div class="button">
						<a href="https://opjindal.distanceeducationschool.in/"><center>	<button type="button" style="padding: 10px; border: 1px solid black; background-color:#002B5C; color: #fff; font-weight:bold;">For More Information Kindly Visit Here</button></center></a>
					</div><!--end of card-->
