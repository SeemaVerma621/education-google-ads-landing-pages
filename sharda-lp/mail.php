...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {	
	...
	// ---------------------------------------------------------
	$url = 'https://script.google.com/macros/s/AKfycbx4uQ61OOG2tXe6qXSEWbrferFW2hIm9YcQVU8oWMrY-JaczmWz8_Gayizbm4WjgLKA/exec';
	$data = array(
		'full_name' => $full_name,
		'email' => $email,
		'phone' => $phone,
		...
		'utm_term' => $utm_term,
		'page_url' => $page_url,
		'website' => 'Sharda DES' // Identifier to differentiate sources
	);
