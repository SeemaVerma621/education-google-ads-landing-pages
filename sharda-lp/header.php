...
<link rel="icon" type="image/x-icon" href="assets/images/favicon-sharda.jpg"/>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-RT6K0N57SF"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-RT6K0N57SF');
</script>
...
})(window,document,'script','dataLayer','GTM-PWFXB2Q4');</script>
