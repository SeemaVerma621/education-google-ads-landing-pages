<style>
	.dislaimer{text-align:left; padding-left:1px; font-size:12px!important; color:#fff; display:block; margin:0px 20px;}
...
<div id="form-ftr">
  ...
  <p>Take a step towards
   your success today</p><br>
    ...
    <form action="mail.php" method="post" name="form" id="myForm">
        ...
        <div class="row">
            <div class="col-md-4" id="ftr-frm">
                <!-- <label>Name<span class="required">*</span></label> -->
                <input type="text" name="full_name" id="full_name" class="form-control" placeholder="Enter Your Name"
                    required>
            </div>
            ...
            <div class="col-md-4" id="ftr-frm">
                <button type="submit" name="submit" value="submit" class=" sub-btn" id="button" style="background:#f7b314!important; margint:0px;">Submit</button>
            </div>
            <div class="col-md-8" id="ftr-frm">
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
    ...
    <span style="font-size: 10px; line-height:1; color:#fff;">I consent to receive university updates via email and mobile number. <span class="disclaimer_popup" onclick="disclaimerModal()" style="cursor:pointer;"><b>Disclaimer</b></span></span>
  </div>
  <span class="checkbox-error" style="color: #fff; font-size: 13px; display: none;"></span>
</div>
</div>
