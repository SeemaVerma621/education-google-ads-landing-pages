            ...
            <div class="splz-form-container">
                ...
                <div id="form">
                    ...
                    <!-- <input type="hidden" name="form_type" value="brochure"> -->
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="Enter Your Email" style="margin-bottom:15px;" required>
						...
						<input type="tel" id="phone" name="phone" class="form-control" placeholder="Enter your phone number" style="width:100%!important;" required>
...
<br>
  ...
  <span class="checkbox-error" style="color: red; font-size: 13px; display: none;"></span>
                        ...
                        <input type="hidden" name="source" id="source" class="form-control" value="LPU" required>
