...
<div id="myModal" class="modal">
    ...
    <div id="downloadbrochuremodal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="splz-form-container">
				  <span class="close1" onclick="closedownloadbrochure()" id="closeButton">&times;</span>
                <div id="form">
                    <div class="frm-heading">
                        <h5><strong><span class="sp-text-blue">&nbsp;&nbsp;Download Brochure</span><br></strong>
				
							<hr>
                        </h5>
                    </div>

                    <form action="mail.php" method="post" name="form" id="brochureForm">
			...
			<option value="BA">BA</option>
                        ...
                        <!-- <label>State<span class="sp-text">*</span></label> -->
                        ...
                        <input type="hidden" name="form_name" id="form_name" class="form-control"
                            value="Download Placement">
                           <input type="hidden" name="show_brochure" value="yes"><!-- ✅ Trigger brochure -->
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
    ...
    <span style="font-size: 11px; line-height:1; color:#fff;">I consent to receive university updates via email and mobile number. <span class="disclaimer_popup" onclick="disclaimerModal()">Disclaimer</span></span>
  </div>
  <span class="checkbox-error" style="color: red; font-size: 13px; display: none;"></span>
</div>

                        <center>
				<button type="submit" id="downloadBrochureBtn" class="sub-btn">Download Brochure</button>

                            
                            <!--<button type="submit" name="submit" value="send" class="sub-btn"-->
                            <!--    id="button-brochure">Download Brochure</button>-->
                        </center>
                    </form>
