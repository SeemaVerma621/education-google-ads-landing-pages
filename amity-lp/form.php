...
<div id="form">
    ...
    <!--    <label>Name<span class="required">*</span></label>-->
       ...
       <!--  <label>Course <span class="required">*</span></label>-->
        <select name="course" class="form-control" id="specialization" required style="margin-top:10px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
    ...
    <span style="font-size: 10px; line-height:1; color:#fff;">I consent to receive university updates via email and mobile number. <span class="disclaimer_popup" onclick="disclaimerModal()" style="color:#8DB3F0;">Disclaimer</span></span>
  </div>
