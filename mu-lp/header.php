...
<link rel="icon" type="image/x-icon" href="assets/images/favicon_managalayatan.webp"/>
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-WKFP6QZN80"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-WKFP6QZN80');
</script>
...
})(window,document,'script','dataLayer','GTM-KLJ39K3S');</script>
