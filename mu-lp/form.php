...
<!-- 
        ...
        <input type="tel" id="phone" name="phone" class="form-control" placeholder="Enter your Number" required width="100%">

     
        <!-- <label>Course <span class="required">*</span></label> -->
        <select name="course" class="form-control" id="course" style="margin-top:10px;" required >
  ...
  <span class="checkbox-error" style="color: red; font-size: 13px; display: none;"></span>
        ...
        <input type="hidden" name="source" id="source" class="form-control" value="Mang LP" required>
