...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {	
	...
	// ---------------------------------------------------------
	$url = 'https://script.google.com/macros/s/AKfycbxWuKCyGLWU0PQ_hYibYfs5beIXaORObd6RkL7jGnw5-Ljw45Ax_Jp1d8sxM_JbGq2-/exec';
	$data = array(
		'full_name' => $full_name,
		'email' => $email,
		'phone' => $phone,
		...
		'utm_term' => $utm_term,
		'page_url' => $page_url,
		'website' => 'Degree DES' // Identifier to differentiate sources
	);
