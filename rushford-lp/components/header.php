...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/faviconV2.png"/>
    <title>Online DBA Course at Rushford University | Doctorate in Business Administration </title>
    <meta decription="Online DBA Course at Rushford University | Doctorate in Business Administration. Find Online Course Fees, Eligibility and Admission Details 2025.">
    <meta keyword="">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-XZE7MNESRP"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-XZE7MNESRP');
</script>
...
})(window,document,'script','dataLayer','GTM-5P3869ZL');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5P3869ZL"
    ...
    <div class="container">
        <nav class="nav">
            ...
            <div class="nav-header">
                    ...
                    <a href="https://rushford.distanceeducationschool.in/">  
                        <img src="assets/img/rushford-logo.webp" class="logo" alt="Logo">
                    </a>
