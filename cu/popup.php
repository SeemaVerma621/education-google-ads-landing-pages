 ...
 <div id="downloadbrochuremodal" class="modal">
        ...
        <div class="modal-content">
            ...
            <div class="splz-form-container">
				  <span class="close-popup" onclick="closedownloadbrochure()" id="closeButton">&times;</span>
                <div id="form">
  ...
  <div style="display: flex; align-items: center; gap: 8px;">
    ...
    <span style="font-size: 11px; line-height:1;">I consent to receive university updates via email and mobile number. <span class="disclaimer_popup" onclick="disclaimerModal()">Disclaimer</span></span>
  </div>
  <span class="checkbox-error" style="color: red; font-size: 13px; display: none;"></span>
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content">
			 <div class="splz-form-container">
				  <span class="close-popup" onclick="closePopup()" id="closeButton">&times;</span>
