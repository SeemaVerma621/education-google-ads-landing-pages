...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/FaviconIIM.png"/>
    <title> IIM Kozhikode HR Analytics & HRM Online Certification Courses</title>
    <meta decription="IIM Kozhikode HRM and HR Analytics courses. Learn workforce planning, talent analytics, and HR tools like Excel, Tableau, and Power BI.
">
    <meta keyword="IIM Kozhikode, hr analytics course, hr analytics certification">
...
<meta name="google-site-verification" content="eIuqW8QRNv9-_U6fidXuaBXWK1mb6FpFl0bcMww5km0" />
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JKZ06T6NG4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JKZ06T6NG4');
</script>
...
})(window,document,'script','dataLayer','GTM-WMQ6B2ZG');</script>
